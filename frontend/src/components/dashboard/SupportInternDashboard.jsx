...
function SupportInternDashboard({ allRepairsStats }) {
  return (
      ...
      <div className="grid lg:grid-cols-12 grid-rows- gap-5">
        ...
        <div className="flex flex-col  col-span-4 bg-white gap-3 border shadow-md rounded-md p-5">
          ...
          <Link to={"/repairs/create-repair"}>
            <div className="flex gap-2 border rounded-md p-2 shadow-md">
              <div className="w-[52px] h-[52px] flex items-center justify-center bg-purple-50 border border-purple-500 rounded-full">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col">
                  <span className="text-sm text-slate-500">Log a new repairs request</span>
                </div>
              </div>
            </div>
          </Link>
          ...
          <Link to={"/repairs"}>
            <div className="flex gap-2 border rounded-md p-2 shadow-md">
              <div className="w-[52px] h-[52px] flex items-center justify-center bg-blue-50 border border-blue-500 rounded-full">
                <LuSearch size={25} className="text-blue-600" />
              </div>
              <div className="flex flex-col gap-2">
                <span className="text-sm text-black">View Repairs</span>
                <div className="flex flex-col">
                  <span className="text-sm text-slate-500">Log a new repairs request</span>
                </div>
              </div>
        ...
        <div className="flex flex-col  col-span-4 bg-white gap-3 border shadow-md rounded-md p-5">
          <div className="flex justify-between">
            <span className=" font-semibold text-black">Anouncements</span>
          </div>
...
export default SupportInternDashboard;
