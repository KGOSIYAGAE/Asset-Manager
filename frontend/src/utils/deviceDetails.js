    ...
    manufatures: [
      {
        ...
        deviceModel: [
          ...
          { id: 8, name: "ProBook 455 G9", specification: "15.6 Intel enterprise" },
    ...
    manufatures: [
      {
        ...
        deviceModel: [
          { id: 1, name: "24f", specification: "24 FHD IPS" },
          { id: 2, name: "E24 G4", specification: "USB-C business monitor" },
          { id: 3, name: "E27 G4", specification: "27 IPS ergonomic" },
          { id: 4, name: "E27 G5", specification: "27 IPS ergonomic" },
          { id: 5, name: "Z27k G3", specification: "4K professional display" },
          { id: 6, name: "M24fw", specification: "Home office monitor" },
        ],
      },
      {
        id: 2,
    ...
    manufatures: [
      {
        ...
        deviceModel: [
          { id: 1, name: "LaserJet Pro M404dn", specification: "Monochrome laser printer" },
          { id: 2, name: "LaserJet Pro MFP M428fdw", specification: "All-in-one wireless" },
          { id: 3, name: "Color LaserJet Pro MFP M479fdw", specification: "Color multifunction printer" },
          { id: 4, name: "Smart Tank 515", specification: "Ink tank printer" },
          { id: 5, name: "DeskJet 2720", specification: "Home inkjet printer" },
          { id: 6, name: "OfficeJet Pro 9010", specification: "Business inkjet printer" },
          { id: 7, name: "LaserJet Enterprise M507dn", specification: "Enterprise laser printer" },
        ],
      },
      {
        id: 2,
        ...
        deviceModel: [
          { id: 1, name: "PIXMA G3411", specification: "Ink tank printer" },
          { id: 2, name: "PIXMA TS3340", specification: "Home inkjet printer" },
          { id: 3, name: "imageCLASS MF445dw", specification: "Laser multifunction" },
          { id: 4, name: "LBP6030w", specification: "Compact laser printer" },
          { id: 5, name: "MAXIFY GX6040", specification: "High volume ink tank" },
        ],
      },
      {
        id: 3,
        ...
        deviceModel: [
          { id: 1, name: "L3250", specification: "EcoTank ink printer" },
          { id: 2, name: "L5290", specification: "All-in-one ink tank" },
          { id: 3, name: "EcoTank L8050", specification: "Photo printer" },
          { id: 4, name: "WorkForce WF-2830", specification: "Office inkjet" },
        ],
      },
      {
        id: 4,
        ...
        deviceModel: [
          { id: 1, name: "HL-L2350DW", specification: "Monochrome laser" },
          { id: 2, name: "DCP-L2540DW", specification: "All-in-one laser" },
          { id: 3, name: "MFC-L2750DW", specification: "Wireless laser MFP" },
        ],
      },
    ],
  },
    ...
    manufatures: [
      {
        ...
        deviceModel: [
          { id: 1, name: "AU7000", specification: "4K Smart TV" },
          { id: 2, name: "Q60B", specification: "QLED 4K TV" },
          { id: 3, name: "Q80C", specification: "Premium QLED TV" },
        ],
      },
      {
        id: 2,
        ...
        deviceModel: [
          { id: 1, name: "UP7750", specification: "4K LED TV" },
          { id: 2, name: "OLED C2", specification: "Premium OLED display" },
          { id: 3, name: "NanoCell 80", specification: "NanoCell 4K TV" },
        ],
      },
    ],
  },
